...
const l1Exercises: Exercise[] = [
  ...
  },
  {
    ...
    kind: 'categorize',
    competencyId: 'riskReturn',
    rationale: 'Reading risk metrics correctly means knowing which values signal a better or worse risk profile.',
    instruction: 'Sort each signal into a better or worse risk profile.',
    buckets: [
      { id: 'better', label: 'Better risk profile' },
      { id: 'worse', label: 'Worse risk profile' },
    ],
    items: [
      { id: 'sharpe', text: 'A high Sharpe ratio', bucketId: 'better' },
      { id: 'lowsd', text: 'A low standard deviation', bucketId: 'better' },
      { id: 'steady', text: 'Steady, small price swings', bucketId: 'better' },
      { id: 'beta2', text: 'A beta of 2.0', bucketId: 'worse' },
      { id: 'dd', text: 'A huge maximum drawdown', bucketId: 'worse' },
      { id: 'wild', text: 'Wild, large price swings', bucketId: 'worse' },
    ],
  },
  {
    id: 'inv4-l1-e8',
    ...
    competencyId: 'riskReturn',
    rationale: 'Risk-adjusted return (Sharpe) — not raw return — is the right lens for comparing investments.',
    story: 'Fund X returned 8% with low volatility (Sharpe 1.2). Fund Y returned 9% but with wild swings (Sharpe 0.5). For most investors, which is the better risk-adjusted choice?',
    choices: [
      { id: 'a', text: 'Fund X — it delivered more return per unit of risk (higher Sharpe)', outcome: 'Correct. A slightly lower return with far less risk is usually the better deal — and easier to hold through rough patches.', isCorrect: true, score: 3 },
      { id: 'b', text: 'Fund Y — the higher raw return always wins', outcome: 'Raw return ignores the risk taken to get it. The extra 1% came with much wilder swings, a poor trade-off.', isCorrect: false, score: 1 },
      { id: 'c', text: 'It\'s impossible to compare them', outcome: 'The Sharpe ratio exists precisely to compare them: return per unit of risk. Fund X wins clearly.', isCorrect: false, score: 0 },
    ],
  },
  {
    id: 'inv4-l1-e9',
    kind: 'miniStory',
    competencyId: 'riskReturn',
    rationale: 'A return far above safe rates with "no risk" violates the risk-return relationship and is a classic scam signal.',
    panels: [
      { text: 'An ad promises "guaranteed 15% annual returns, no risk." Casey is tempted to move her whole savings in.', speaker: 'Narrator' },
      { text: 'Casey recalls that higher returns always come bundled with higher risk.', speaker: 'Narrator' },
    ],
    choicePrompt: 'What should the "no risk, 15%" promise tell Casey?',
    choices: [
      { id: 'a', text: 'It\'s a red flag — returns far above safe rates with "no risk" usually signal a scam', isCorrect: true, outcome: 'Right. If something truly paid 15% risk-free, the whole world would pile in and the rate would vanish. Guaranteed high returns don\'t exist.' },
      { id: 'b', text: 'It\'s a great deal she should grab immediately', isCorrect: false, outcome: 'The risk-return law has no exceptions. "Guaranteed high return, no risk" is the signature of fraud.' },
    ],
  },
  {
    id: 'inv4-l1-e10',
    kind: 'multipleChoice',
    competencyId: 'riskReturn',
    rationale: 'Beta scales market moves: a beta of 0.5 means about half the market\'s move.',
    prompt: 'A stock has a beta of 0.5. If the market rises 10%, you\'d expect this stock to:',
    options: [
      { id: 'a', text: 'Rise about 5% — it is less volatile than the market', isCorrect: true },
      { id: 'b', text: 'Rise about 20%', isCorrect: false },
      { id: 'c', text: 'Fall about 5%', isCorrect: false },
      { id: 'd', text: 'Rise exactly 10%', isCorrect: false },
    ],
  },
];
...
const l2Exercises: Exercise[] = [
  ...
  },
  {
    ...
    kind: 'matchPairs',
    competencyId: 'riskReturn',
    rationale: 'These four terms are the backbone of portfolio theory and diversification.',
    instruction: 'Match each term to its definition.',
    pairs: [
      { id: 'p1', term: 'Systematic risk', definition: 'Market-wide risk that can\'t be diversified away' },
      { id: 'p2', term: 'Unsystematic risk', definition: 'Company-specific risk that can be diversified away' },
      { id: 'p3', term: 'Diversification', definition: 'Holding many uncorrelated assets to lower risk' },
      { id: 'p4', term: 'Correlation', definition: 'How closely two assets move together' },
    ],
  },
  {
    id: 'inv4-l2-e8',
    kind: 'tapToOrder',
    competencyId: 'riskReturn',
    rationale: 'More holdings across more sectors leave less unsystematic risk. Ranking makes the dose-response clear.',
    instruction: 'Order these from MOST to LEAST unsystematic (company-specific) risk remaining.',
    items: [
      { id: 's1', text: 'One single stock', rank: 1 },
      { id: 's2', text: 'Five stocks, all in one sector', rank: 2 },
      { id: 's3', text: 'Thirty stocks across many sectors', rank: 3 },
      { id: 's4', text: 'A total-market index fund', rank: 4 },
    ],
  },
  {
    id: 'inv4-l2-e9',
    kind: 'miniStory',
    competencyId: 'riskReturn',
    rationale: 'Diversification depends on low correlation, not the raw count of holdings. 25 banks are effectively one bet.',
    panels: [
      { text: 'Priya brags she\'s diversified: "I own 25 different stocks!" Then a banking crisis hits.', speaker: 'Narrator' },
      { text: 'All 25 of her holdings are banks. They fall together — down 40%.', speaker: 'Narrator' },
    ],
    choicePrompt: 'Why wasn\'t Priya actually diversified?',
    choices: [
      { id: 'a', text: 'Diversification depends on low correlation, not just the number of stocks — 25 banks move together', isCorrect: true, outcome: 'Exactly. Spreading across one sector leaves you exposed to that sector\'s risk. Real diversification needs assets that move differently.' },
      { id: 'b', text: 'She was diversified — owning 25 stocks is always enough', isCorrect: false, outcome: 'Count isn\'t the point. Twenty-five highly correlated stocks behave almost like one. Correlation is what matters.' },
    ],
  },
  {
    id: 'inv4-l2-e10',
    kind: 'multipleChoice',
    competencyId: 'riskReturn',
    rationale: 'Research shows ~20-30 uncorrelated stocks remove most unsystematic risk; more adds little.',
    prompt: 'Roughly how many well-chosen, uncorrelated stocks remove most unsystematic risk?',
    options: [
      { id: 'a', text: 'About 20-30', isCorrect: true },
      { id: 'b', text: 'About 3-5', isCorrect: false },
      { id: 'c', text: 'Exactly 100', isCorrect: false },
      { id: 'd', text: 'At least 500', isCorrect: false },
    ],
  },
];
...
const l3Exercises: Exercise[] = [
  ...
  },
  {
    ...
    kind: 'matchPairs',
    competencyId: 'riskReturn',
    rationale: 'These four terms are essential before ever opening a margin account.',
    instruction: 'Match each margin term to its meaning.',
    pairs: [
      { id: 'p1', term: 'Initial margin', definition: 'Equity % needed to open a position (Reg T ~50%)' },
      { id: 'p2', term: 'Maintenance margin', definition: 'Minimum equity before a margin call (~25%)' },
      { id: 'p3', term: 'Margin call', definition: 'A demand to add cash or be force-sold' },
      { id: 'p4', term: 'Leverage', definition: 'Using borrowed money to amplify exposure' },
    ],
  },
  {
    id: 'inv4-l3-e8',
    kind: 'scenarioDecision',
    competencyId: 'riskReturn',
    rationale: 'Leverage magnifies your return on equity: a 20% asset gain becomes ~40% on 2× leverage.',
    story: 'You put in $5,000 and borrow $5,000 to buy $10,000 of stock. It rises 20%. Ignoring interest, what is your return on YOUR money?',
    choices: [
      { id: 'a', text: 'About 40% — the $2,000 gain is earned on your $5,000 of equity', outcome: 'Correct. $10,000 → $12,000 is a $2,000 gain. On your own $5,000, that\'s a 40% return — leverage doubled it.', isCorrect: true, score: 3 },
      { id: 'b', text: '20% — the same as the stock', outcome: 'That ignores leverage. Because you only put up half the money, your percentage gain is doubled.', isCorrect: false, score: 1 },
      { id: 'c', text: '10%', outcome: 'Leverage amplifies, not shrinks, your return on equity. The answer is ~40%.', isCorrect: false, score: 0 },
    ],
  },
  {
    id: 'inv4-l3-e9',
    kind: 'miniStory',
    competencyId: 'riskReturn',
    rationale: 'Leverage cuts both ways — a moderate drop can wipe out equity while the full loan remains, triggering a fast margin call.',
    panels: [
      { text: 'Jordan buys $20,000 of stock using $10,000 of his own money and $10,000 borrowed. The stock drops 35%.', speaker: 'Narrator' },
      { text: 'His broker calls: equity has fallen below maintenance. "Add cash now, or we sell your shares."', speaker: 'Narrator' },
    ],
    choicePrompt: 'Why did a 35% drop trigger a margin call so quickly?',
    choices: [
      { id: 'a', text: 'Leverage amplified the loss — the $7,000 decline hit his $10,000 equity while the full $10,000 loan still stood', isCorrect: true, outcome: 'Right. The position fell to $13,000; subtract the $10,000 loan and only $3,000 equity remains — below the maintenance threshold.' },
      { id: 'b', text: 'Brokers issue margin calls at random', isCorrect: false, outcome: 'Margin calls are triggered by a precise rule: equity falling below the maintenance margin. Leverage just gets you there faster.' },
    ],
  },
  {
    id: 'inv4-l3-e10',
    kind: 'multipleChoice',
    competencyId: 'riskReturn',
    rationale: 'Margin interest = loan × rate × time. $10,000 × 8% × 1 year = $800.',
    prompt: 'You borrow $10,000 on margin at 8% annual interest and hold for one year. Ignoring any gains, the interest you owe is:',
    options: [
      { id: 'a', text: '$800', isCorrect: true },
      { id: 'b', text: '$80', isCorrect: false },
      { id: 'c', text: '$8,000', isCorrect: false },
...
const l4PracticeExercises: Exercise[] = [
  ...
  },
  {
    ...
    kind: 'matchPairs',
    competencyId: 'riskReturn',
    rationale: 'A quick recall check on the four core risk metrics.',
    instruction: 'Match each metric to what it measures.',
    pairs: [
      { id: 'p1', term: 'Standard deviation', definition: 'Volatility — how spread out returns are' },
      { id: 'p2', term: 'Beta', definition: 'Sensitivity to overall market moves' },
      { id: 'p3', term: 'Sharpe ratio', definition: 'Return earned per unit of risk' },
      { id: 'p4', term: 'Max drawdown', definition: 'Largest peak-to-trough decline' },
    ],
  },
  {
    id: 'inv4-pr-n2',
    kind: 'fillBlank',
    competencyId: 'riskReturn',
    rationale: 'Diversification removes company-specific risk but not market-wide risk.',
    template: 'Diversification can remove ___ risk, but it cannot remove ___ risk.',
    blanks: ['unsystematic', 'systematic'],
    wordBank: ['unsystematic', 'systematic', 'credit', 'liquidity', 'total', 'random'],
  },
  {
    id: 'inv4-pr-n3',
    kind: 'categorize',
    competencyId: 'riskReturn',
    rationale: 'Classifying events sharpens the systematic vs. unsystematic distinction.',
    instruction: 'Classify each event as systematic (market-wide) or unsystematic (company-specific).',
    buckets: [
      { id: 'sys', label: 'Systematic' },
      { id: 'unsys', label: 'Unsystematic' },
    ],
    items: [
      { id: 'rates', text: 'The central bank hikes interest rates', bucketId: 'sys' },
      { id: 'recall', text: 'One carmaker recalls a faulty model', bucketId: 'unsys' },
      { id: 'recession', text: 'A global recession begins', bucketId: 'sys' },
      { id: 'ceo', text: 'A single company\'s CEO resigns in scandal', bucketId: 'unsys' },
      { id: 'infl', text: 'Inflation spikes across the economy', bucketId: 'sys' },
      { id: 'lawsuit', text: 'One firm loses a patent lawsuit', bucketId: 'unsys' },
    ],
  },
  {
    id: 'inv4-pr-n4',
    kind: 'tapToOrder',
    competencyId: 'riskReturn',
    rationale: 'Re-ranking the risk spectrum reinforces relative riskiness across asset classes.',
    instruction: 'Order these from LOWEST to HIGHEST typical risk.',
    items: [
      { id: 's1', text: '3-month Treasury bills', rank: 1 },
      { id: 's2', text: 'Investment-grade corporate bonds', rank: 2 },
      { id: 's3', text: 'An S&P 500 index fund', rank: 3 },
      { id: 's4', text: 'A single small-cap growth stock', rank: 4 },
      { id: 's5', text: 'Bitcoin', rank: 5 },
    ],
  },
  {
    id: 'inv4-pr-n5',
    kind: 'trueFalse',
    competencyId: 'riskReturn',
    rationale: 'Leverage is symmetric: it multiplies both gains and losses on your equity.',
    statement: 'Borrowing on margin amplifies both your potential gains and your potential losses.',
    isTrue: true,
  },
  {
    id: 'inv4-pr-n6',
    kind: 'scenarioDecision',
    competencyId: 'riskReturn',
    rationale: 'Modest leverage on a diversified position is defensible; heavy leverage on a single speculative bet is reckless.',
    story: 'Which use of margin is the most reasonable?',
    choices: [
      { id: 'a', text: 'Using 20% margin to modestly amplify a diversified ETF you plan to hold', outcome: 'Most reasonable. Low leverage on a broad, lower-volatility holding keeps margin-call risk small.', isCorrect: true, score: 3 },
      { id: 'b', text: 'Borrowing 90% of the position to buy a single meme stock', outcome: 'Extremely risky — a small drop in a volatile single stock can trigger a forced sale and wipe out your equity.', isCorrect: false, score: 0 },
      { id: 'c', text: 'Doubling down on margin to average down a big loser', outcome: 'Adding leverage to a losing position multiplies the danger. This is how accounts get blown up.', isCorrect: false, score: 0 },
    ],
  },
];
...
const l5Exercises: Exercise[] = [
  ...
  },
  {
    ...
    kind: 'matchPairs',
    competencyId: 'riskReturn',
    rationale: 'These four terms describe the full short-selling lifecycle and its unique dangers.',
    instruction: 'Match each term to its meaning.',
    pairs: [
      { id: 'p1', term: 'Short selling', definition: 'Borrow, sell, buy back lower, return the shares' },
      { id: 'p2', term: 'Covering', definition: 'Buying shares back to close a short position' },
      { id: 'p3', term: 'Short squeeze', definition: 'A rising price forcing shorts to buy, pushing it higher' },
      { id: 'p4', term: 'Borrow fee', definition: 'The cost to borrow hard-to-find shares' },
    ],
  },
  {
    id: 'inv4-l4-e8',
    kind: 'fillBlank',
    competencyId: 'riskReturn',
    rationale: 'Shorting reverses the order — sell first, buy later — and its loss is unbounded because price has no ceiling.',
    template: 'In a short sale you ___ shares first and buy them back later. Your maximum loss is theoretically ___, because the price can rise without limit.',
    blanks: ['sell', 'unlimited'],
    wordBank: ['sell', 'buy', 'unlimited', 'capped', 'zero', 'fixed'],
  },
  {
    id: 'inv4-l4-e9',
    kind: 'miniStory',
    competencyId: 'riskReturn',
    rationale: 'Without a stop-loss, a short squeeze can produce losses far larger than the original position — the signature risk of shorting.',
    panels: [
      { text: 'Sky shorts a heavily-shorted meme stock at $20 with no stop-loss. "It\'s obviously overvalued."', speaker: 'Narrator' },
      { text: 'A coordinated buying frenzy sends it to $90. Sky\'s broker force-closes the position at a brutal loss.', speaker: 'Narrator' },
    ],
    choicePrompt: 'What is the core lesson?',
    choices: [
      { id: 'a', text: 'Shorting has unlimited loss potential — without a stop-loss, a squeeze can be catastrophic', isCorrect: true, outcome: 'Right. Being "right eventually" doesn\'t help if a squeeze forces you out first. A pre-set stop-loss is non-negotiable when shorting.' },
      { id: 'b', text: 'Shorting is risk-free as long as your thesis is correct', isCorrect: false, outcome: 'Even a correct thesis can be ruined by timing and a squeeze. Price can rise far past "fair value" before it falls.' },
    ],
  },
  {
    id: 'inv4-l4-e10',
    kind: 'multipleChoice',
    competencyId: 'riskReturn',
    rationale: 'A long can only fall to zero (−100%); a short loses as the price rises, which is unbounded.',
    prompt: 'What is the maximum theoretical loss on a long stock position versus a short position?',
    options: [
      { id: 'a', text: 'Long: 100%. Short: unlimited', isCorrect: true },
      { id: 'b', text: 'Both: 100%', isCorrect: false },
      { id: 'c', text: 'Long: unlimited. Short: 100%', isCorrect: false },
      { id: 'd', text: 'Both: unlimited', isCorrect: false },
    ],
  },
];
...
const l6Exercises: Exercise[] = [
  ...
  },
  {
    ...
    kind: 'multipleChoice',
    competencyId: 'riskReturn',
    rationale: 'Net profit = gross profit minus borrowing cost = $3,000 - $150 = $2,850. Borrowing costs always reduce a short trade, never add to it.',
    prompt: 'You short a stock for a $3,000 gross profit, but pay $150 in borrowing costs. What is your net profit?',
    options: [
      { id: 'a', text: '$2,850', isCorrect: true },
      { id: 'b', text: '$3,150 (added the cost instead of subtracting)', isCorrect: false },
      { id: 'c', text: '$3,000 (ignored the borrowing cost)', isCorrect: false },
      { id: 'd', text: '$2,700', isCorrect: false },
    ],
  },
  {
    id: 'inv4-l5-e4',
  ...
  },
  {
    ...
    kind: 'matchPairs',
    competencyId: 'riskReturn',
    rationale: 'These four tools turn risk management from a vague intention into a concrete process.',
    instruction: 'Match each risk-management tool to its meaning.',
    pairs: [
      { id: 'p1', term: 'Stop-loss', definition: 'A pre-set price that auto-exits a losing trade' },
      { id: 'p2', term: 'Position sizing', definition: 'Deciding how much to risk on a trade' },
      { id: 'p3', term: '2% rule', definition: 'Risk no more than 2% of your portfolio per trade' },
      { id: 'p4', term: 'Hedging', definition: 'Taking an offsetting position to reduce risk' },
    ],
  },
  {
    id: 'inv4-l5-e8',
    kind: 'trueFalse',
    competencyId: 'riskReturn',
    rationale: 'A stop-loss caps the downside regardless of whether the thesis was right — that is its whole purpose.',
    statement: 'A pre-set stop-loss can limit your loss even if your trade thesis turns out to be wrong.',
    isTrue: true,
  },
  {
    id: 'inv4-l5-e9',
    kind: 'fillBlank',
    competencyId: 'riskReturn',
    rationale: 'Position size is driven by the distance to your stop, not the entry price — the heart of the 2% rule.',
    template: 'The 2% rule: never risk more than ___% of your portfolio per trade. Max shares = (Portfolio × 2%) ÷ ___ distance per share.',
    blanks: ['2', 'stop'],
    wordBank: ['2', '10', 'stop', 'entry', 'exit', 'target'],
  },
  {
    id: 'inv4-l5-e10',
    kind: 'categorize',
    competencyId: 'riskReturn',
    rationale: 'Distinguishing disciplined practices from reckless ones is the capstone judgment of the unit.',
    instruction: 'Sort each practice into sound risk management or reckless.',
    buckets: [
      { id: 'sound', label: 'Sound risk management' },
      { id: 'reckless', label: 'Reckless' },
    ],
    items: [
      { id: 'stop', text: 'Setting a stop-loss before entering', bucketId: 'sound' },
      { id: 'size', text: 'Sizing positions to a max 2% loss', bucketId: 'sound' },
      { id: 'hedge', text: 'Hedging a concentrated position', bucketId: 'sound' },
      { id: 'allin', text: 'Going all-in on one leveraged bet', bucketId: 'reckless' },
      { id: 'avgdown', text: 'Adding to a loser with no plan', bucketId: 'reckless' },
      { id: 'noshortstop', text: 'Shorting with no stop-loss', bucketId: 'reckless' },
    ],
  },
];
