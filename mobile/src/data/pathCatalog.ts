...
const lesson2Exercises: Exercise[] = [
  ...
  },
  {
    ...
    kind: 'multipleChoice',
    competencyId: 'moneyMindset',
    rationale: 'A $150/month habit is $18,000 contributed over 10 years. At 7% it compounds to about $26,000, so roughly $8,000 of growth is the opportunity cost of spending it instead.',
    prompt: 'You spend $150 a month on a habit. Over 10 years that is $18,000 you put in. If you invested that $150/month at 7% instead, about how much would you end up with?',
    options: [
      { id: 'a', text: 'About $26,000', isCorrect: true },
      { id: 'b', text: 'About $18,000 (only what you put in)', isCorrect: false },
      { id: 'c', text: 'About $21,000', isCorrect: false },
      { id: 'd', text: 'About $40,000', isCorrect: false },
    ],
  },
  {
    id: 'l2-e3',
...
const lesson4Exercises: Exercise[] = [
  ...
  },
  {
    ...
    kind: 'multipleChoice',
    competencyId: 'budgetDesign',
    rationale: 'Surplus is income minus every expense: $4,200 - $2,040 - $1,540 = $620. Subtracting only one expense category is the common mistake.',
    prompt: "Jordan brings home $4,200 a month. Her fixed costs are $2,040 and her variable costs are $1,540. What is her monthly surplus (income minus all expenses)?",
    options: [
      { id: 'a', text: '$620', isCorrect: true },
      { id: 'b', text: '$2,160 (forgot the variable costs)', isCorrect: false },
      { id: 'c', text: '$2,660 (forgot the fixed costs)', isCorrect: false },
      { id: 'd', text: '$1,540', isCorrect: false },
    ],
  },
  {
    id: 'l4-e3',
...
const lesson5Exercises: Exercise[] = [
  ...
  },
  {
    ...
    kind: 'multipleChoice',
    competencyId: 'savingSystems',
    rationale: 'Add the monthly essentials ($900 + $350 + $150 + $200 = $1,600), then multiply by 6 months: $9,600.',
    prompt: 'Your monthly essentials are rent $900, food $350, utilities $150, and transport $200. What is your 6-month emergency fund target?',
    options: [
      { id: 'a', text: '$9,600', isCorrect: true },
      { id: 'b', text: '$1,600 (only one month)', isCorrect: false },
      { id: 'c', text: '$4,800 (only 3 months)', isCorrect: false },
      { id: 'd', text: '$19,200 (12 months)', isCorrect: false },
    ],
  },
  {
    id: 'l5-e4',
...
const u2l2: Exercise[] = [
  ...
  { id: 'u2-l2-e6', kind: 'trueFalse', competencyId: 'budgetDesign',
    ...
    isTrue: false },
  { id: 'u2-l2-e7', kind: 'multipleChoice', competencyId: 'budgetDesign',
    rationale: 'Surplus is income minus all expenses: $3,000 - $1,200 - $800 = $1,000.',
    prompt: 'Your net monthly income is $3,000. Fixed expenses are $1,200 and variable expenses are $800. What is your monthly surplus?',
    options: [
      { id: 'a', text: '$1,000', isCorrect: true },
      { id: 'b', text: '$1,800 (forgot variable expenses)', isCorrect: false },
      { id: 'c', text: '$2,200 (forgot fixed expenses)', isCorrect: false },
...
const u2l3: Exercise[] = [
  ...
  { id: 'u2-l3-e4', kind: 'multipleChoice', competencyId: 'budgetDesign',
    rationale: 'Under 50/30/20, savings is 20% of take-home: $2,800 x 0.20 = $560.',
    prompt: 'Apply the 50/30/20 rule to a $2,800/month take-home. How much should go to savings (the 20% slice)?',
    options: [
      { id: 'a', text: '$560', isCorrect: true },
      { id: 'b', text: '$1,400 (that is the 50% needs slice)', isCorrect: false },
      { id: 'c', text: '$840 (that is the 30% wants slice)', isCorrect: false },
...
const u2l5: Exercise[] = [
  ...
  { id: 'u2-l5-e2', kind: 'multipleChoice', competencyId: 'budgetDesign',
    rationale: 'Needs is the 50% slice: $2,800 x 0.50 = $1,400.',
    prompt: "Jordan takes home $2,800/month. Under 50/30/20, what is her monthly Needs target (the 50% slice)?",
    options: [
      { id: 'a', text: '$1,400', isCorrect: true },
      { id: 'b', text: '$840 (that is the 30% wants slice)', isCorrect: false },
      { id: 'c', text: '$560 (that is the 20% savings slice)', isCorrect: false },
      { id: 'd', text: '$2,240', isCorrect: false },
    ] },
...
const u3l1: Exercise[] = [
  ...
  { id: 'u3-l1-e4', kind: 'trueFalse', competencyId: 'savingSystems',
    ...
    isTrue: false },
  { id: 'u3-l1-e5', kind: 'multipleChoice', competencyId: 'savingSystems',
    rationale: '$200/month is $72,000 contributed over 30 years, but at 7% compound growth it becomes roughly $227,000. Starting 10 years later (only 20 years of growth) would leave about $98,000.',
    prompt: 'You save $200/month at 7% for 30 years. That is $72,000 of your own money put in. About how much will you actually have?',
    options: [
      { id: 'a', text: 'About $227,000', isCorrect: true },
      { id: 'b', text: 'About $72,000 (only what you put in)', isCorrect: false },
      { id: 'c', text: 'About $98,000 (if you started 10 years later)', isCorrect: false },
      { id: 'd', text: 'About $120,000', isCorrect: false },
    ] },
...
const u3l2: Exercise[] = [
  ...
  { id: 'u3-l2-e6', kind: 'multipleChoice', competencyId: 'savingSystems',
    rationale: '$100/month is $12,000 contributed over 10 years; at 5% it compounds to about $15,500. Starting 2 years later would cut it to roughly $12,300.',
    prompt: 'You automate $100/month at 5% for 10 years. You contribute $12,000 in total. About how much will you have?',
    options: [
      { id: 'a', text: 'About $15,500', isCorrect: true },
      { id: 'b', text: 'About $12,000 (only what you put in)', isCorrect: false },
      { id: 'c', text: 'About $13,000', isCorrect: false },
      { id: 'd', text: 'About $20,000', isCorrect: false },
    ] },
...
const u3l3: Exercise[] = [
  ...
  { id: 'u3-l3-e4', kind: 'multipleChoice', competencyId: 'savingSystems',
    rationale: 'Essentials add to $1,700/month ($950 + $400 + $150 + $200). Times 6 months that is $10,200.',
    prompt: 'Your essential monthly costs are rent $950, food $400, utilities $150, and transport $200. What is your 6-month emergency fund target?',
    options: [
      { id: 'a', text: '$10,200', isCorrect: true },
      { id: 'b', text: '$1,700 (only one month)', isCorrect: false },
      { id: 'c', text: '$5,100 (only 3 months)', isCorrect: false },
      { id: 'd', text: '$20,400 (12 months)', isCorrect: false },
    ] },
...
const u3l4: Exercise[] = [
  ...
  { id: 'u3-l4-e2', kind: 'multipleChoice', competencyId: 'savingSystems',
    rationale: 'Monthly savings = goal divided by months: $4,800 / 24 = $200. Interest would let you set aside a little less.',
    prompt: 'You want to save $4,800 in 24 months. Ignoring interest, how much do you need to set aside each month?',
    options: [
      { id: 'a', text: '$200', isCorrect: true },
      { id: 'b', text: '$240', isCorrect: false },
      { id: 'c', text: '$400 (that would reach it in 12 months)', isCorrect: false },
...
const u3l5: Exercise[] = [
  ...
  { id: 'u3-l5-e4', kind: 'multipleChoice', competencyId: 'savingSystems',
    rationale: 'Ignoring interest, $9,600 / $50 = 192 months, which is about 16 years. Saving more each month shrinks the timeline dramatically.',
    prompt: 'Sam saves $50/month toward a $9,600 emergency fund. Ignoring interest, about how long will it take?',
    options: [
      { id: 'a', text: 'About 16 years (192 months)', isCorrect: true },
      { id: 'b', text: 'About 8 years', isCorrect: false },
      { id: 'c', text: 'About 4 years', isCorrect: false },
      { id: 'd', text: 'About 32 years', isCorrect: false },
    ] },
...
const u4l2: Exercise[] = [
  ...
  { id: 'u4-l2-e3', kind: 'trueFalse', competencyId: 'banking',
    ...
    isTrue: false },
  { id: 'u4-l2-e4', kind: 'multipleChoice', competencyId: 'banking',
    rationale: 'Compound growth: $2,000 x 1.04^10 is about $2,960. Simple interest with no compounding would give only $2,800.',
    prompt: 'You deposit $2,000 at 4% APY and leave it for 10 years. About how much will it be worth?',
    options: [
      { id: 'a', text: 'About $2,960', isCorrect: true },
      { id: 'b', text: 'About $2,800 (simple interest, no compounding)', isCorrect: false },
      { id: 'c', text: 'About $2,080', isCorrect: false },
      { id: 'd', text: 'About $4,000', isCorrect: false },
    ] },
...
const u5l1: Exercise[] = [
  ...
  { id: 'u5-l1-e6', kind: 'multipleChoice', competencyId: 'behavior',
    rationale: '$5 x 365 days is $1,825 a year; over 3 years that is $5,475.',
    prompt: 'You spend $5 a day on a habit, every day. Over 3 years, what does it cost in total?',
    options: [
      { id: 'a', text: '$5,475', isCorrect: true },
      { id: 'b', text: '$1,825 (only one year)', isCorrect: false },
      { id: 'c', text: '$5,000', isCorrect: false },
      { id: 'd', text: '$10,950 (that would be 6 years)', isCorrect: false },
    ] },
...
const u5l4: Exercise[] = [
  ...
  { id: 'u5-l4-e2', kind: 'multipleChoice', competencyId: 'behavior',
    rationale: '$85 a month x 12 = $1,020 a year. It is easy to underestimate the subscription stack.',
    prompt: 'Your subscriptions add up to $85 a month. What do they cost over a full year?',
    options: [
      { id: 'a', text: '$1,020', isCorrect: true },
      { id: 'b', text: '$850 (only 10 months)', isCorrect: false },
      { id: 'c', text: '$510 (only 6 months)', isCorrect: false },
...
const u5l5: Exercise[] = [
  ...
  { id: 'u5-l5-e4', kind: 'multipleChoice', competencyId: 'behavior',
    rationale: 'A daily $5 coffee is $5 x 365 = $1,825 a year, before you even count anything else.',
    prompt: "Morgan buys a $5 coffee every day. What does just the coffee cost over one year?",
    options: [
      { id: 'a', text: '$1,825', isCorrect: true },
      { id: 'b', text: '$1,560', isCorrect: false },
      { id: 'c', text: '$150', isCorrect: false },
      { id: 'd', text: '$3,650 (that would be 2 years)', isCorrect: false },
    ] },
...
const u6l2: Exercise[] = [
  ...
  { id: 'u6-l2-e3', kind: 'multipleChoice', competencyId: 'businessFinance',
    rationale: 'Margin = (revenue - costs - tax reserve) / revenue = (1,800 - 1,200 - 180) / 1,800 = 420/1,800, about 23%.',
    prompt: 'Mia sells $1,800/month. Costs are $1,200 and she reserves $180 for tax. What is her profit margin?',
    options: [
      { id: 'a', text: 'About 23%', isCorrect: true },
      { id: 'b', text: 'About 33% (forgot the tax reserve)', isCorrect: false },
      { id: 'c', text: 'About 67%', isCorrect: false },
      { id: 'd', text: 'About 13%', isCorrect: false },
    ] },
...
const u6l3: Exercise[] = [
  ...
  { id: 'u6-l3-e2', kind: 'multipleChoice', competencyId: 'businessFinance',
    rationale: 'Margin = (720 - 360 - 72) / 720 = 288/720 = 40%. That is $288/month, before Sam pays herself for her time.',
    prompt: "Sam's candle business makes $720 revenue a month, with $360 in total costs and a $72 tax reserve. What is her profit margin?",
    options: [
      { id: 'a', text: '40%', isCorrect: true },
      { id: 'b', text: '50% (forgot the tax reserve)', isCorrect: false },
...
const u6l5: Exercise[] = [
  ...
  { id: 'u6-l5-e2', kind: 'multipleChoice', competencyId: 'businessFinance',
    rationale: '20 jobs x $75 = $1,500 revenue. Surplus = 1,500 - 260 fixed - 360 variable = $880.',
    prompt: 'Jay books 20 jobs at $75 each ($1,500 revenue). Fixed costs are $260 and variable costs are $360 total. What is his monthly business surplus?',
    options: [
      { id: 'a', text: '$880', isCorrect: true },
      { id: 'b', text: '$1,240 (forgot variable costs)', isCorrect: false },
      { id: 'c', text: '$1,140 (forgot fixed costs)', isCorrect: false },
      { id: 'd', text: '$620', isCorrect: false },
    ] },
...
const u7l3: Exercise[] = [
  ...
  { id: 'u7-l3-e2', kind: 'multipleChoice', competencyId: 'cashFlow',
    rationale: 'Operating surplus = 8,000 - 3,200 fixed - 2,900 variable = $1,900.',
    prompt: 'A pop-up shop collects $8,000 this month. Fixed costs are $3,200 and inventory plus card fees are $2,900. What is the monthly operating surplus?',
    options: [
      { id: 'a', text: '$1,900', isCorrect: true },
      { id: 'b', text: '$4,800 (forgot inventory and fees)', isCorrect: false },
      { id: 'c', text: '$5,100 (forgot fixed costs)', isCorrect: false },
...
const u7l5: Exercise[] = [
  ...
  { id: 'u7-l5-e2', kind: 'multipleChoice', competencyId: 'financialAnalysis',
    rationale: '72 subs x $19 = $1,368 revenue. Margin = (1,368 - 1,528) / 1,368 = -160/1,368, about -12%. Costs exceed revenue, so month one is a loss.',
    prompt: 'Lena sells 72 subscriptions at $19 ($1,368 revenue). Boxes and ads cost $1,528 combined. What is her first-month margin?',
    options: [
      { id: 'a', text: 'About -12% (a loss)', isCorrect: true },
      { id: 'b', text: 'About +12% (a profit)', isCorrect: false },
      { id: 'c', text: 'About 0% (break-even)', isCorrect: false },
...
const u8l2: Exercise[] = [
  { id: 'u8-l2-e1', kind: 'multipleChoice', competencyId: 'creditScore',
    rationale: 'Utilization = statement balance / credit limit = $750 / $2,500 = 30%. Keeping it under 30% is a major controllable credit-score lever.',
    prompt: 'Your statement balance is $750 and your card limit is $2,500. What is your credit utilization?',
    options: [
      { id: 'a', text: '30%', isCorrect: true },
      { id: 'b', text: '3% (misplaced decimal)', isCorrect: false },
...
const u8l3: Exercise[] = [
  ...
  { id: 'u8-l3-e2', kind: 'multipleChoice', competencyId: 'debtMath',
    rationale: 'At 7% APR over 60 months the payment is about $396. Dividing principal by months ($20,000 / 60 = $333) ignores interest and is too low.',
    prompt: "You finance $20,000 at 7% APR for 60 months. What is the closest monthly payment?",
    options: [
      { id: 'a', text: 'About $396', isCorrect: true },
      { id: 'b', text: 'About $333 (ignores interest)', isCorrect: false },
      { id: 'c', text: 'About $450', isCorrect: false },
      { id: 'd', text: 'About $290', isCorrect: false },
    ] },
  { id: 'u8-l3-e3', kind: 'multipleChoice', competencyId: 'debtMath',
    rationale: 'Total interest = (payment x months) - loan = ($396 x 60) - $20,000 = $23,760 - $20,000 = about $3,760.',
    prompt: 'With a $396 monthly payment on that $20,000 loan over 60 months, how much total interest do you pay?',
    options: [
      { id: 'a', text: 'About $3,760', isCorrect: true },
      { id: 'b', text: 'About $23,760 (that is the total paid, not the interest)', isCorrect: false },
      { id: 'c', text: 'About $2,000', isCorrect: false },
      { id: 'd', text: 'About $7,920', isCorrect: false },
    ] },
...
const u8l5: Exercise[] = [
  ...
  { id: 'u8-l5-e2', kind: 'multipleChoice', competencyId: 'creditScore',
    rationale: 'Utilization = balance / limit = $600 / $2,000 = 30%. Paying down from $1,200 (60%) to $600 halves it.',
    prompt: 'Jules pays a card down to a $600 balance on a $2,000 limit. What is the new credit utilization?',
    options: [
      { id: 'a', text: '30%', isCorrect: true },
      { id: 'b', text: '60% (the old $1,200 balance)', isCorrect: false },
...
const u9l2: Exercise[] = [
  { id: 'u9-l2-e1', kind: 'multipleChoice', competencyId: 'taxPlanning',
    rationale: 'Paid every two weeks means 26 checks a year: $210 x 26 = $5,460 withheld annually.',
    prompt: 'Your paycheck withholds $210 for federal tax every two weeks (26 paychecks a year). About how much is withheld for the year?',
    options: [
      { id: 'a', text: '$5,460', isCorrect: true },
      { id: 'b', text: '$2,520 (used 12 monthly checks)', isCorrect: false },
      { id: 'c', text: '$2,730', isCorrect: false },
      { id: 'd', text: '$10,920', isCorrect: false },
    ] },
...
const u9l4: Exercise[] = [
  ...
  { id: 'u9-l4-e2', kind: 'multipleChoice', competencyId: 'taxPlanning',
    rationale: 'Cash after reserve = 900 - 120 expenses - 195 tax reserve = $585.',
    prompt: 'Riley earns $900, spends $120 on supplies, and reserves $195 for tax. How much is left before personal spending?',
    options: [
      { id: 'a', text: '$585', isCorrect: true },
      { id: 'b', text: '$780 (forgot the tax reserve)', isCorrect: false },
      { id: 'c', text: '$705 (forgot supplies)', isCorrect: false },
...
const u10l3: Exercise[] = [
  ...
  { id: 'u10-l3-e3', kind: 'multipleChoice', competencyId: 'incomeGrowth',
    rationale: 'Annual value = $80/month x 12 = $960. Annualizing a benefit makes it easy to compare against other offers.',
    prompt: 'A commute benefit saves you $80/month. What is it worth over a full year?',
    options: [
      { id: 'a', text: '$960', isCorrect: true },
      { id: 'b', text: '$80', isCorrect: false },
      { id: 'c', text: '$480 (only 6 months)', isCorrect: false },
      { id: 'd', text: '$1,920 (that would be 2 years)', isCorrect: false },
    ] },
];
...
const u10l4: Exercise[] = [
  { id: 'u10-l4-e1', kind: 'multipleChoice', competencyId: 'businessFinance',
    rationale: 'Margin = (800 - 120 - 160) / 800 = 520/800 = 65%.',
    prompt: 'A weekend tutoring side hustle brings in $800/month, costs $120 for materials, and reserves $160 for tax. What is its profit margin?',
    options: [
      { id: 'a', text: '65%', isCorrect: true },
      { id: 'b', text: '85% (forgot the tax reserve)', isCorrect: false },
...
const u11l1: Exercise[] = [
  ...
  { id: 'u11-l1-e3', kind: 'multipleChoice', competencyId: 'financialAnalysis',
    rationale: "Net income = revenue minus all costs. The four costs (food $140k, labor $72k, rent $36k, other $18k) total $266k, so $280k - $266k = a thin $14,000 profit. Being busy does not guarantee a healthy margin.",
    prompt: "Read Mike's P&L: Revenue $280,000, with costs of food $140,000, labor $72,000, rent $36,000, and other $18,000. What is his net income?",
    options: [
      { id: 'a', text: '$14,000 profit', isCorrect: true },
      { id: 'b', text: '$104,000 (forgot labor and other)', isCorrect: false },
      { id: 'c', text: '$190,000 (forgot food and rent)', isCorrect: false },
      { id: 'd', text: '$140,000', isCorrect: false },
    ] },
...
const u11l2: Exercise[] = [
  ...
  { id: 'u11-l2-e2', kind: 'multipleChoice', competencyId: 'businessFinance',
    rationale: 'Cash left = 4,500 - 1,200 fixed - 1,700 inventory = $1,600.',
    prompt: 'A shop collects $4,500, pays $1,200 in fixed costs, and plans $1,700 of inventory. How much cash is left?',
    options: [
      { id: 'a', text: '$1,600', isCorrect: true },
      { id: 'b', text: '$3,300 (forgot inventory)', isCorrect: false },
      { id: 'c', text: '$2,800 (forgot fixed costs)', isCorrect: false },
      { id: 'd', text: '$1,400', isCorrect: false },
    ] },
...
const u12l2: Exercise[] = [
  { id: 'u12-l2-e1', kind: 'multipleChoice', competencyId: 'insuranceRisk',
    rationale: 'Reserve needed = deductible + uncovered costs - cash on hand = 1,000 + 300 - 450 = $850.',
    prompt: 'A renter has a $1,000 deductible, expects $300 of uncovered costs, and has $450 ready. How much extra reserve is needed?',
    options: [
      { id: 'a', text: '$850', isCorrect: true },
      { id: 'b', text: '$1,300 (forgot cash on hand)', isCorrect: false },
      { id: 'c', text: '$550', isCorrect: false },
      { id: 'd', text: '$700', isCorrect: false },
    ] },
...
const u12l5: Exercise[] = [
  ...
  { id: 'u12-l5-e2', kind: 'multipleChoice', competencyId: 'liquidity',
    rationale: 'Reserve gap = 1,000 + 500 - 700 saved = $800 still needed.',
    prompt: 'Ari wants $1,000 for auto deductible risk and $500 for renters deductible risk, and has $700 saved. What is the reserve gap?',
    options: [
      { id: 'a', text: '$800', isCorrect: true },
      { id: 'b', text: '$1,500 (forgot the savings)', isCorrect: false },
      { id: 'c', text: '$300', isCorrect: false },
      { id: 'd', text: '$1,200', isCorrect: false },
    ] },
...
const u13l3: Exercise[] = [
  { id: 'u13-l3-e1', kind: 'multipleChoice', competencyId: 'financialAnalysis',
    rationale: 'Margin = (1,200 - 760 - 120) / 1,200 = 320/1,200, about 27%.',
    prompt: 'A launch sells $1,200 of product. Costs and ads total $760, and the tax reserve is $120. What is the launch margin?',
    options: [
      { id: 'a', text: 'About 27%', isCorrect: true },
      { id: 'b', text: 'About 37% (forgot the tax reserve)', isCorrect: false },
      { id: 'c', text: 'About 63%', isCorrect: false },
      { id: 'd', text: 'About 15%', isCorrect: false },
    ] },
...
const u13l5: Exercise[] = [
  ...
  { id: 'u13-l5-e2', kind: 'multipleChoice', competencyId: 'financialAnalysis',
    rationale: 'Launch cash = 1,100 - 250 ads - 180 delivery = $670.',
    prompt: 'Sam books $1,100 of shoots, spends $250 on ads, and pays $180 in delivery costs. How much launch cash is left before tax?',
    options: [
      { id: 'a', text: '$670', isCorrect: true },
      { id: 'b', text: '$850 (forgot delivery costs)', isCorrect: false },
      { id: 'c', text: '$920 (forgot ad spend)', isCorrect: false },
      { id: 'd', text: '$430', isCorrect: false },
    ] },
...
const u14l1: Exercise[] = [
  ...
  { id: 'u14-l1-e2', kind: 'multipleChoice', competencyId: 'cashFlow',
    rationale: 'Cash after housing = 3,200 - 1,350 rent - 210 utilities and insurance = $1,640.',
    prompt: 'Ava takes home $3,200. Rent is $1,350 and utilities plus renters insurance are $210. How much is left after housing?',
    options: [
      { id: 'a', text: '$1,640', isCorrect: true },
      { id: 'b', text: '$1,850 (forgot utilities and insurance)', isCorrect: false },
      { id: 'c', text: '$2,990 (forgot rent)', isCorrect: false },
      { id: 'd', text: '$1,460', isCorrect: false },
    ] },
...
const u14l3: Exercise[] = [
  { id: 'u14-l3-e1', kind: 'multipleChoice', competencyId: 'liquidity',
    rationale: 'Cash gap = savings - rent and deposit - setup = 2,400 - 2,500 - 350 = -$450, so they are short by $450.',
    prompt: 'A renter has $2,400 saved. Move-in needs $2,500 (first month plus deposit) and $350 in setup costs. What is the cash gap?',
    options: [
      { id: 'a', text: 'Short by $450', isCorrect: true },
      { id: 'b', text: 'Short by $100 (forgot setup costs)', isCorrect: false },
      { id: 'c', text: 'Exactly enough', isCorrect: false },
      { id: 'd', text: 'Short by $850', isCorrect: false },
    ] },
...
const u15l1: Exercise[] = [
  ...
  { id: 'u15-l1-e2', kind: 'multipleChoice', competencyId: 'cashFlow',
    rationale: 'Cash after transportation = 3,000 - 360 car payment - 370 insurance and running costs = $2,270.',
    prompt: 'Jordan takes home $3,000. The car payment is $360 and insurance plus running costs are $370. How much is left after transportation?',
    options: [
      { id: 'a', text: '$2,270', isCorrect: true },
      { id: 'b', text: '$2,640 (forgot insurance and running costs)', isCorrect: false },
      { id: 'c', text: '$2,630 (forgot the car payment)', isCorrect: false },
      { id: 'd', text: '$1,900', isCorrect: false },
    ] },
...
const u15l2: Exercise[] = [
  { id: 'u15-l2-e1', kind: 'multipleChoice', competencyId: 'debtMath',
    rationale: 'At 9% APR over 48 months the payment is about $348. Dividing the principal by months ($14,000 / 48 = $292) ignores interest and understates it.',
    prompt: 'What is the closest monthly payment on a $14,000 auto loan at 9% APR over 48 months?',
    options: [
      { id: 'a', text: 'About $348', isCorrect: true },
      { id: 'b', text: 'About $292 (ignores interest)', isCorrect: false },
      { id: 'c', text: 'About $420', isCorrect: false },
      { id: 'd', text: 'About $263', isCorrect: false },
    ] },
...
const u15l4: Exercise[] = [
  { id: 'u15-l4-e1', kind: 'multipleChoice', competencyId: 'insuranceRisk',
    rationale: 'Reserve gap = deductible + uncovered costs - cash on hand = 750 + 300 - 400 = $650.',
    prompt: 'A driver has a $750 deductible, expects $300 in uncovered repairs, and has $400 saved. What is the reserve gap (what they still need)?',
    options: [
      { id: 'a', text: '$650', isCorrect: true },
      { id: 'b', text: '$1,050 (forgot the $400 saved)', isCorrect: false },
      { id: 'c', text: '$1,450', isCorrect: false },
...
const u15l5: Exercise[] = [
  ...
  { id: 'u15-l5-e2', kind: 'multipleChoice', competencyId: 'budgetDesign',
    rationale: 'Annual cost = $9/day x 220 days = $1,980.',
    prompt: 'A commute costs $9/day for parking and extra fuel, for 220 working days a year. What is the annual commute cost?',
    options: [
      { id: 'a', text: '$1,980', isCorrect: true },
      { id: 'b', text: '$3,285 (used 365 days)', isCorrect: false },
      { id: 'c', text: '$990', isCorrect: false },
...
const u16l3: Exercise[] = [
  { id: 'u16-l3-e1', kind: 'multipleChoice', competencyId: 'retirementPlanning',
    rationale: 'You put in about $55,000 ($1,000 start plus $150 x 360 months), but at 7% it compounds to roughly $190,000 over 30 years.',
    prompt: 'You start with $1,000, add $150/month, and earn 7% for 30 years. You contribute about $55,000 of your own money. About how much will you have?',
    options: [
      { id: 'a', text: 'About $190,000', isCorrect: true },
      { id: 'b', text: 'About $55,000 (only what you put in)', isCorrect: false },
      { id: 'c', text: 'About $100,000', isCorrect: false },
      { id: 'd', text: 'About $250,000', isCorrect: false },
    ] },
...
const u17l3: Exercise[] = [
  { id: 'u17-l3-e1', kind: 'multipleChoice', competencyId: 'portfolioConstruction',
    rationale: 'Weighted return = 0.70 x 8% + 0.30 x 3% = 5.6% + 0.9% = 6.5%. A plain average of 8 and 3 (5.5%) ignores the weights.',
    prompt: 'A portfolio is 70% stocks returning 8% and 30% bonds returning 3%. What is the expected annual return?',
    options: [
      { id: 'a', text: '6.5%', isCorrect: true },
      { id: 'b', text: '5.5% (plain average, ignores the weights)', isCorrect: false },
...
const u18l4: Exercise[] = [
  ...
  { id: 'u18-l4-e3', kind: 'multipleChoice', competencyId: 'financialAnalysis',
    rationale: 'Margin = (2,000 - 1,050 - 250) / 2,000 = 700/2,000 = 35%.',
    prompt: 'A paid pilot earns $2,000, delivery costs $1,050, and the tax reserve is $250. What is the pilot margin?',
    options: [
      { id: 'a', text: '35%', isCorrect: true },
      { id: 'b', text: '47.5% (forgot the tax reserve)', isCorrect: false },
...
const u19l4: Exercise[] = [
  { id: 'u19-l4-e1', kind: 'multipleChoice', competencyId: 'businessFinance',
    rationale: 'Cash before owner pay = income - operating costs - tax reserve = 7,000 - 3,800 - 900 = $2,300.',
    prompt: 'A business brings in $7,000. Operating costs are $3,800 and the tax reserve is $900. How much cash is left before owner pay?',
    options: [
      { id: 'a', text: '$2,300', isCorrect: true },
      { id: 'b', text: '$3,200 (forgot the tax reserve)', isCorrect: false },
      { id: 'c', text: '$6,100 (forgot operating costs)', isCorrect: false },
      { id: 'd', text: '$1,400', isCorrect: false },
    ] },
